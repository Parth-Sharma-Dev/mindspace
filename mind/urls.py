...
urlpatterns = [
    ...
    path("rooms/<uuid:room_id>/", views.chat_room, name="chat_room"),
    path("rooms/<uuid:room_id>/messages/", views.fetch_messages, name="fetch_messages"),
    ...
    path(
        "api/rooms/<uuid:room_id>/messages/new/",
    ...
    path(
        "api/forum/posts/",
        views.ForumPostListCreateView.as_view(),
        name="post-list-create",
    ),
    path(
        "api/forum/posts/<uuid:pk>/",
        views.ForumPostDetailView.as_view(),
        name="post-detail",
    ),
    path(
        "api/forum/posts/<uuid:post_id>/comments/new/",
        views.ForumCommentCreateView.as_view(),
        name="comment-create",
    ),
]
